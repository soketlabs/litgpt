...
from litgpt.scripts.convert_pth_to_safetensor import convert_pth_to_safetensors as convert_pth_to_safetensors_fn
...
PARSER_DATA = {
    ...
    "convert_pth_to_safetensors": convert_pth_to_safetensors_fn,
