...
@dataclass
class RespiratoryAI(DataModule):
    """RespiratoryAI data module for supervised finetuning."""
    ...
    repo_id: str = "allenai/big-reasoning-traces"
    ...
    def prepare_data(self) -> None:
        ...
        load_dataset(self.repo_id, "DeepSeek",token=self.access_token)

    def setup(self, stage: str = "") -> None:
        from datasets import load_dataset

        dataset = load_dataset(self.repo_id,"DeepSeek", token=self.access_token)
